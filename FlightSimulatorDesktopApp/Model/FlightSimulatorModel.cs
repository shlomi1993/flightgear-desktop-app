...
namespace FlightSimulatorDesktopApp.Model
{
    public class FlightSimulatorModel : IFlightSimulatorModel
    {
        ...
        // Constructor.
        public FlightSimulatorModel(IConnectionModel cm, IDataModel dm)
        {
            telnetClient = cm;
            database = dm;
            isConnected = false;
        ...
        // BE ADVISED that the first property must be Aileron!
        ...
        public double Time
        {
            ...
            set
            {
                ...
                {
                    currentTime = (0.1 * (1 / Speed)) * IRow;
                    NotifyPropertyChanged("Time");
                }
            }
        }

        public IDataModel DataModel { get => database; }
